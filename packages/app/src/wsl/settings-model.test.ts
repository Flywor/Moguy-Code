...
describe("WSL server settings presentation", () => {
  ...
  test("offers install and update only when MoguyCode needs attention", () => {
  ...
  test("probes the selected distro before entering the MoguyCode step", async () => {
    const calls: string[] = []
