...
export const dict = {
  ...
  "command.agent.backgroundSubagents": "背景執行子代理",
  "command.agent.backgroundSubagents.description": "將執行中的子代理分離到背景，讓主會話繼續",
  ...
  "dialog.model.unpaid.freeModels.title": "MoguyCode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 MoguyCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "MoguyCode Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 MoguyCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 MoguyCode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 MoguyCode 伺服器。",
  ...
  "toast.subagents.backgrounded.title": "子代理已轉入背景",
  "toast.subagents.backgrounded.description": "執行中的子代理會在背景繼續。",
  "toast.subagents.backgrounded.none.title": "沒有轉入背景的子代理",
  "toast.subagents.backgrounded.none.description": "目前沒有阻塞此工作階段的同步子代理。",
  "toast.subagents.backgrounded.failed.title": "背景執行子代理失敗",

  "toast.session.listFailed.title": "無法載入 {{project}} 的工作階段",

  "toast.update.title": "有可用更新",
  "toast.update.description": "MoguyCode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 MoguyCode 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: MoguyCode 暫不支援 MCP 認證。',
  ...
  "sidebar.right.open": "展開右側欄",
  "sidebar.right.close": "收起右側欄",
  ...
  "sidebar.gettingStarted.line1": "MoguyCode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 MoguyCode 伺服器。",
  ...
  "settings.general.row.language.description": "變更 MoguyCode 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 MoguyCode 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 MoguyCode 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 MoguyCode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 MoguyCode 啟動時自動檢查更新",
  ...
  "settings.skills.description": "技能設定將在此處可設定。",
  "settings.skills.search.placeholder": "搜尋技能",
  "settings.skills.empty": "未找到技能",
  "settings.skills.error": "無法載入技能",
  "settings.skills.count": "{{count}} 個技能",
  "settings.skills.slash": "斜線命令",
  "settings.skills.source.claude": "Claude Code",
  "settings.skills.source.agents": "Agents",
  "settings.skills.source.opencode": "MoguyCode",
  "settings.skills.source.custom": "自訂",
  ...
  "session.header.subagents": "子代理",
  "session.header.subagents.active": "{{count}} 個活躍",
  "session.header.subagents.recent": "{{count}} 個最近",
  "session.header.subagents.status.running": "執行中",
  "session.header.subagents.status.error": "錯誤",
  "session.header.subagents.status.completed": "已完成",
  "session.header.subagents.status.responded": "已回覆",
