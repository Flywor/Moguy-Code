...
export const dict = {
  ...
  "command.agent.backgroundSubagents": "后台运行子智能体",
  "command.agent.backgroundSubagents.description": "将运行中的子智能体分离到后台，让主会话继续",
  ...
  "dialog.provider.opencode.note": "使用 MoguyCode Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "MoguyCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 MoguyCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "MoguyCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 MoguyCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 MoguyCode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 MoguyCode 服务器。",
  ...
  "toast.subagents.backgrounded.title": "子智能体已转入后台",
  "toast.subagents.backgrounded.description": "运行中的子智能体会在后台继续。",
  "toast.subagents.backgrounded.none.title": "没有转入后台的子智能体",
  "toast.subagents.backgrounded.none.description": "当前没有阻塞此会话的同步子智能体。",
  "toast.subagents.backgrounded.failed.title": "后台运行子智能体失败",
  "toast.session.listFailed.title": "无法加载 {{project}} 的会话",
  "toast.update.title": "有可用更新",
  "toast.update.description": "MoguyCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 MoguyCode 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: MoguyCode 暂不支持 MCP 认证。',
  ...
  "sidebar.right.open": "展开右侧栏",
  "sidebar.right.close": "收起右侧栏",
  ...
  "sidebar.gettingStarted.line1": "MoguyCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 MoguyCode 服务器。",
  ...
  "settings.general.row.language.description": "更改 MoguyCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 MoguyCode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 MoguyCode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 MoguyCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 MoguyCode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 MoguyCode。",
  ...
  "settings.skills.description": "技能设置将在此处可配置。",
  "settings.skills.search.placeholder": "搜索技能",
  "settings.skills.empty": "未找到技能",
  "settings.skills.error": "无法加载技能",
  "settings.skills.count": "{{count}} 个技能",
  "settings.skills.slash": "斜杠命令",
  "settings.skills.source.claude": "Claude Code",
  "settings.skills.source.agents": "Agents",
  "settings.skills.source.opencode": "MoguyCode",
  "settings.skills.source.custom": "自定义",
  ...
  "session.header.subagents": "子智能体",
  "session.header.subagents.active": "{{count}} 个活跃",
  "session.header.subagents.recent": "{{count}} 个最近",
  "session.header.subagents.status.running": "运行中",
  "session.header.subagents.status.error": "错误",
  "session.header.subagents.status.completed": "已完成",
  "session.header.subagents.status.responded": "已回复",
  "session.header.subagents.status.mentioned": "已提及",
