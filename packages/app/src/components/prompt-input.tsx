...
export const PromptInput: Component<PromptInputProps> = (props) => {
  ...
  const agentNames = createMemo(() => props.controls.agents.options)
  ...
  const { abort, handleSubmit } =
    ...
    createPromptSubmit({
      ...
      onShellSubmit: props.controls.terminal.open,
    })
              ...
              <div class="pointer-events-none absolute bottom-2 left-2 flex items-center gap-1.5">
                ...
                <Show when={store.mode === "normal" || store.mode === "shell"}>
                  <div class="flex items-center gap-1.5 min-w-0 relative">
                    ...
                    <div class="flex items-center gap-1.5 min-w-0 h-7">
                                      ...
                                      <For each={agentNames()}>
                                        {(agent) => (
                                          ...
                                          >
                                            ...
                                            <Show when={props.controls.agents.current === agent}>
