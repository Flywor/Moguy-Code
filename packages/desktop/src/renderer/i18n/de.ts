export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von MoguyCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von MoguyCode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
