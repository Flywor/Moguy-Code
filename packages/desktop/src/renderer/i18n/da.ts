export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af MoguyCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af MoguyCode er blevet downloadet. Vil du installere den og genstarte?",
