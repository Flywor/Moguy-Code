export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av MoguyCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av MoguyCode er lastet ned. Vil du installere den og starte på nytt?",
