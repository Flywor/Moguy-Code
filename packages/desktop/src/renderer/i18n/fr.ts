export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'MoguyCode",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'MoguyCode a été téléchargée. Voulez-vous l'installer et redémarrer ?",
