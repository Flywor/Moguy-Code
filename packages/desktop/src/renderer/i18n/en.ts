export const dict = {
  ...
  "desktop.updater.none.message": "You are already using the latest version of MoguyCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of MoguyCode has been downloaded, would you like to install it and relaunch?",
