export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji MoguyCode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} MoguyCode. Czy chcesz ją zainstalować i uruchomić ponownie?",
