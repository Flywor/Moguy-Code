...
const productName = channel === "prod" ? "MoguyCode" : `MoguyCode ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      MoguyCode is an agent that helps you write and run code with any AI model.
    </p>
  </description>
