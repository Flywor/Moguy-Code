...
<html>
  <head><title>MoguyCode - Snowflake Authorization Successful</title></head>
  <body style="font-family: system-ui; display:flex; align-items:center; justify-content:center; height:100vh; margin:0; background:#111; color:#eee;">
    <div style="text-align:center; max-width:36rem; padding:2rem;">
      ...
      <p>You can close this window and return to MoguyCode.</p>
    </div>
...
<html>
  <head><title>MoguyCode - Snowflake Authorization Failed</title></head>
  <body style="font-family: system-ui; display:flex; align-items:center; justify-content:center; height:100vh; margin:0; background:#111; color:#eee;">
      ...
      methods: [
        {
          ...
          async authorize(inputs = {}) {
            ...
            return {
              url,
              instructions:
                "Complete Snowflake sign-in in your browser. MoguyCode will capture the OAuth callback and store the bearer token automatically.",
